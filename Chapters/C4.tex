...
\label{sec:functions_form_a_vector_space}
	...
	So the vector space of square-integrable functions on $[0,1]$ is an inner product space\index{Inner Product Space}. It is denoted\footnote{\textbf{HERE SAY SOMETHING ABOUT LEBESGUE VS RIEMANN INTEGRATION}} by $L^2[0,1]$. 
