	...
	\begin{defn}[Tangent Space]
		The tangent space\index{Manifold!Tangent Space} at a point $p$ of a manifold $M$, $T_p M$ is the set of all directional derivative operators at $p$.
	\end{defn}
