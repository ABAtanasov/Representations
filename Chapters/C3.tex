...
\section{The Notion of a Form}
	...
	To go from a 0-form to a 1-form, we applied the exterior derivative operator, which could just be written as:
	\begin{equation}
	...
	\section{The Wedge Product} % (fold)
