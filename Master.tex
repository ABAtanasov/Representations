...
\usepackage{amsmath}
% \usepackage{epipart} This is causing problems
\usepackage{epigraph}
\usepackage{makeidx} % packages for math typing
...
\include{Chapters/P0C0Philosophy}
...
\include{Chapters/P1C1DifferentialGeometry}
\printindex
\end{document}
